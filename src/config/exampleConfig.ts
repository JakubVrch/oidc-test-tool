...
import { ResponseTypeValue, ResponseModeValue } from "@/services/types/responseTypeAndValue";
...
export const prefillConfig: PrefillConfig<FormValues> = [
  {
  ...
  },
    {
      ...
      description: 'Gets an id token via fragment from my Auth0 test instance so the response can be inspected',
      data: {
        authEndpoint: 'https://dev-bfpvq5utqmrksbsp.us.auth0.com/authorize',
        clientId: 'U9986Zh55XpwTKKGFncIm2uziHKqzq09',
        redirectUri: 'https://calm-plant-0cc61d103.6.azurestaticapps.net/redirect',
    ...
    },
    {
      ...
      description: 'Gets a code via query from my Auth0 test instance so the response can be inspected',
      data: {
        authEndpoint: 'https://dev-bfpvq5utqmrksbsp.us.auth0.com/authorize',
        clientId: 'U9986Zh55XpwTKKGFncIm2uziHKqzq09',
        redirectUri: 'https://calm-plant-0cc61d103.6.azurestaticapps.net/redirect',
